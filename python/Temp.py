...
class TFTDarkLeakageAnalysis:
    ...
    def __main__(self):
        ...
        self.Button7 = tkinter.Button(self.InputinfoFrame, text='Configuration', command=lambda: self.Configurations(self.ROI_Data))
        self.Button7.grid(column=col, row=2, columnspan=Entry7Span)
        col = col + Entry7Span

        Entry8Span = 2
        self.Button8 = tkinter.Button(self.InputinfoFrame, text='Calculate',
                                      command=lambda: self.Calculate(self.ROI_Data, self.ROIWidget))
        ...
        Entry9Span = 2
        self.Button9 = tkinter.Button(self.InputinfoFrame, text='IQR Remove', command=lambda: self.IQR(self.ROI_Data,
                                                                                                       self.NIQR.get(),
                                                                                                       self.NIteration.get(),
                                                                                                       self.ROIWidget))
